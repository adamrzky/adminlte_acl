        ...
        <div class="row">
		    <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="name" TERMINAL_LABEL="{{ $merchant->TERMINAL_LABEL }}"  class="form-control col-3" >
              
            
           
                
                    <strong>MERCHANT_COUNTRY:</strong>
                    <input type="text" name="MERCHANT_COUNTRY" value="{{ $merchant->MERCHANT_COUNTRY }}" class="form-control col-3" >
              
            
           
                
                    <strong>QRIS_MERCHANT_DOMESTIC_ID:</strong>
                     <input type="text" name="QRIS_MERCHANT_DOMESTIC_ID" value="{{ $merchant->QRIS_MERCHANT_DOMESTIC_ID }}" class="form-control col-3" >
                    ...
                    <strong>MERCHANT_TYPE:</strong>
                     <input type="text" name="MERCHANT_TYPE" value="{{ $merchant->MERCHANT_TYPE }}" class="form-control col-3" >
                    ...
                    <strong>REKENING_NUMBER:</strong>
                     <input type="text" name="REKENING_NUMBER" value="{{ $merchant->REKENING_NUMBER }}" class="form-control col-3" >
                    ...
                    <strong>STATUS:</strong>
                     <input type="text" name="STATUS" value="{{ $merchant->STATUS }}" class="form-control col-3" >
              
            
           
                
                    <strong>MERCHANT_ADDRESS:</strong>
                     <input type="text" name="MERCHANT_ADDRESS" value="{{ $merchant->MERCHANT_ADDRESS }}" class="form-control col-3" >
                </div>
